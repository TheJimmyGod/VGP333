...
public class FireTower : MonoBehaviour
{
    ...
    private FireGun _gun;

    public string _enemyTag = "Enemy";
    public string DataSourceId = "FireTower";
    public string _name;
    public float _range;
    ...
    private void Awake()
    {
        if (ServiceLocator.Get<FireTower>() == null)
        {
            ServiceLocator.Register<FireTower>(this);
        }
        ...
        _gun = GetComponentInChildren<FireGun>();
        if (_gun == null)
        {
